...
Follow our [installation guide for web-based AI](/docs/how-to/connect-chatgpt-to-anki/) to get started!

## Learn More

Want to dive deeper?

- [Web Installation Guide](/docs/how-to/connect-chatgpt-to-anki/) - Step-by-step setup for web-based AI
