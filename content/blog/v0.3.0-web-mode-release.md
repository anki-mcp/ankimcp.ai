...
→ [Web Installation Guide](/docs/how-to/connect-chatgpt-to-anki/)

Still using Claude Desktop? Nothing changes for you:

→ [Desktop Installation Guide](/docs/how-to/connect-claude/#claude-desktop)
...
- [Community Forum](https://forum.ankimcp.ai/)
