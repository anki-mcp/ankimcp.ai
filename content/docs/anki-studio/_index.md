...
description: "Anki Studio is AnkiMCP's cloud side: your AI reaches a knowledge roadmap, a media library, and a card-building sandbox through one Studio MCP endpoint, separate from the tunnel to your local Anki."
keywords:
  - anki studio
  - ankimcp studio
...
Today, Studio gives your AI three things:
