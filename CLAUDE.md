...
- `partials/footer.html` — Adds Newsletter/Email/Community Forum/Status links (Status points to https://status.ankimcp.ai/); keeps Hextra's `displayPoweredBy`/copyright logic (driven by `params.footer` in hugo.yaml)
